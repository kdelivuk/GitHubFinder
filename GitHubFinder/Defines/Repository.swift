...
//        case openIssues = "open_issues_count"
    ...
    public init(id: Int, name: String) { //, watchers: Int, forks: Int, openIssues: Int) {
        self.id = id
//        self.owner = owner
        self.name = name
...
public struct Mocks {
    public static let repositoryMock = Repository(id: 0, name: "Test repository") //, watchers: 10, forks: 11, openIssues: 12)
}
